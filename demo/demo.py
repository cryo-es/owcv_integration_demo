...
SAVED_VIBE_INTENSITY = config["demo"]["SAVED_VIBE_INTENSITY"]
ELIM_VIBE_INTENSITY = config["demo"]["ELIM_VIBE_INTENSITY"]
ASSIST_VIBE_INTENSITY = config["demo"]["ASSIST_VIBE_INTENSITY"]
RESURRECT_VIBE_INTENSITY = config["demo"]["RESURRECT_VIBE_INTENSITY"]
HEAL_BEAM_VIBE_INTENSITY = config["demo"]["HEAL_BEAM_VIBE_INTENSITY"]
DAMAGE_BEAM_VIBE_INTENSITY = config["demo"]["DAMAGE_BEAM_VIBE_INTENSITY"]
RESURRECT_VIBE_DURATION = config["demo"]["RESURRECT_VIBE_DURATION"]
SAVED_VIBE_DURATION = config["demo"]["SAVED_VIBE_DURATION"]
ELIM_VIBE_DURATION = config["demo"]["ELIM_VIBE_DURATION"]
ASSIST_VIBE_DURATION = config["demo"]["ASSIST_VIBE_DURATION"]
